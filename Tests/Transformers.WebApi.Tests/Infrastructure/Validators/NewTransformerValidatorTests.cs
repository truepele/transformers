...
{
    public class NewTransformerValidatorTests
    {
        private readonly NewTransformerValidator _validator = new NewTransformerValidator();
        private readonly NewTransformerDto _dto = new()
        {
